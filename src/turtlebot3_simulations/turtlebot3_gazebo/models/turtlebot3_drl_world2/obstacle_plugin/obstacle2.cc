...
namespace gazebo
{
  ...
  public:
    void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
    {
      ...
      key->Translation(ignition::math::Vector3d(-0.5, 0.0, 0.0));
      key->Rotation(ignition::math::Quaterniond(0, 0, 0));
      ...
      key->Translation(ignition::math::Vector3d(-4.5, 0.0, 0.0));
      key->Rotation(ignition::math::Quaterniond(0, 0, 0));

      key = anim->CreateKeyFrame(130);
      key->Translation(ignition::math::Vector3d(-6.5, 0.0, 0.0));
      key->Rotation(ignition::math::Quaterniond(0, 0, 0));

      key = anim->CreateKeyFrame(140);
      key->Translation(ignition::math::Vector3d(-7.0, 0.0, 0.0));
      key->Rotation(ignition::math::Quaterniond(0, 0, 0));
