...
namespace gazebo
{
  class RandomPositionOnSimStart2 : public ModelPlugin
  {
  private:
  ...
  public:
    void Load(physics::ModelPtr _model, sdf::ElementPtr /*_sdf*/)
    {
      ...
      this->updateConnection = event::Events::ConnectWorldReset(
          std::bind(&RandomPositionOnSimStart2::OnUpdate, this));
    }
    ...
    ignition::math::Vector3d GenerateRandomPosition()
    {
      ...
      std::mt19937 gen(rd());
      std::uniform_real_distribution<> disX(2.5, 4); // Customize your range for x
      std::uniform_real_distribution<> disY(-0.37, 0);  // Customize your range for y
  ...
  GZ_REGISTER_MODEL_PLUGIN(RandomPositionOnSimStart2)
}
